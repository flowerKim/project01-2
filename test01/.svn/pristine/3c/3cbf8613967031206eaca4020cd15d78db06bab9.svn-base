...
//  public Object insert(Member member, @RequestParam(required=false) MultipartFile photo1) {
//    Map<String, Object> result = new HashMap<String, Object>();
//    
...
//  
  ...
  public Object update(Member member, 
      @RequestParam(required=false) MultipartFile photo1, HttpSession session) {
    Map<String, Object> result = new HashMap<String, Object>();
